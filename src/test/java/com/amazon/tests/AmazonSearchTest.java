...
public class AmazonSearchTest {
	...
	search_amazon() {
		...
		AmazonRegistrationPage registerUser=signinUser.NewCustomerSignIn("testamazonusr78@gmail.com");
		AmazonSelectDeliveryAdressPage selectAddress=registerUser.registerUser("testamazonusr78@gmail.com");
